    ...
    <div class="card-body login-card-body">
      ...
      <form method="post" action="">
        <div class="input-group mb-3">
          <input type="whatsappno" class="form-control" name="whatsappno" id="whatsappno" placeholder="Whatsapp No." required>
        ...
        <span class="text-red"> <?php echo form_error('whatsappno'); ?> </span>
        <!-- <div class="input-group mb-3">
