...
// ********************     add unit     ************************
  ...
  public function add_unit(){
    ...
    // print_r($_POST);
    $this->form_validation->set_rules('unit_code', 'unit_code', 'trim|required');
    if ($this->form_validation->run() != FALSE) {
      $save_data = array(
      ...
      // print_r($save_data);
      $this->User_Model->save_data('unit_master', $save_data);
  ...
  public function unit_list(){
    ...
    // $out_roll_id = $this->session->userdata('out_roll_id');
    // if($out_user_id == '' && $out_company_id == ''){ header('location:'.base_url().'User'); }
    $data['unit_list'] = $this->User_Model->unit_list('unit_id');
...
/*******************************  Check Duplication  ****************************/
    ...
    $this->load->view('Include/footer');  
     ...
     public function view_banner() {
         $data['banner_list'] = $this->User_Model->banner_list('bannerid');
            ...
            $this->load->view('Include/head',$data);
            $this->load->view('Include/navbar',$data);
            $this->load->view('User/banner_list',$data);
            $this->load->view('Include/footer',$data);
    }
  ...
  public function edit_banner($bannerid){
    ...
    $this->load->view('Include/head',$data);
    $this->load->view('Include/navbar',$data);
    $this->load->view('User/banner',$data);
    $this->load->view('Include/footer',$data);
  }
